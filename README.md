...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-01 20:53`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/8f9855c0-5365-453d-897b-21513ef2f7da.git
$ cd 8f9855c0-5365-453d-897b-21513ef2f7da
```
